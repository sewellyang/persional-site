...
package com.sewell.common.core.result;
...
public class R<T> implements Serializable {
	...
	private static final long serialVersionUID = -7935489901801163055L;
	@Getter
	@Setter
	private int code;
	...
	public static <T> R<T> failedE(IErrCode eC) {
		return restResult(null, eC.getCode(), eC.getMessage());
	}
